            ...
            <div className="max-w-5xl w-full bg-card border border-border rounded-2xl shadow-xl p-8 md:p-15">
                <div className="space-y-5 text-card-foreground">
                    <p className="text-sm lg:text-lg leading-relaxed">
                        I am a passionate Computer Science student with a strong interest in software engineering and
                        fullstack development. I enjoy building projects that both solve problems and allow me to express 
                        my creativity. I'm currently pursuing a Bachelor's of Science and I'm always learning new technologies 
                        as I'm currently learning React/Native, Tailwind, TypeScript and Go, outside of regular coursework.
                    </p>
